...
import { SKATE_TRICK_AREAS, areaTagClass } from '~/utils/skateTrickTaxonomy'
...
const areaOptions = computed(() =>
  props.options?.length ? props.options : SKATE_TRICK_AREAS,
)
  ...
  <div class="flex flex-wrap gap-2">
    <button
      ...
      :class="[
        ...
        modelValue === opt
          ? [areaTagClass(opt), 'border-transparent ring-1 ring-white/25']
