...
import { format, isToday, addDays, formatDistanceToNow, startOfMonth, endOfMonth, eachDayOfInterval, getDay, isBefore, isAfter, isSameDay } from 'date-fns'
...
const openStudentDashboard = (student: any) => {
  ...
  navigateTo(`/member/coach/students/${student.id}`)
}
