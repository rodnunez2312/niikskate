...
onMounted(async () => {
  if (!user.value) {
    router.push('/auth/login?redirect=/member/admin/academy/dashboard')
    return
  }
...
const goToCoachAvailability = () => router.push('/member/admin/scheduling/coaches')
      ...
      <div class="px-4 py-4 max-w-2xl mx-auto">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            <button type="button" @click="router.push('/member/admin/academy')" class="p-2 -ml-2 text-white">
    ...
    <div v-else-if="isAdmin" class="px-4 py-6 max-w-2xl mx-auto space-y-6">
      ...
      <section>
        ...
        <div class="space-y-2">
          ...
          <NuxtLink 
            to="/member/admin/academy/programs"
            class="flex items-center gap-4 bg-gray-900 border border-gray-800 rounded-2xl p-4 hover:border-gray-700 transition-all"
          >
