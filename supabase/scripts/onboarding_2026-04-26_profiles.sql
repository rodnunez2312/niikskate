...
-- auth.users includes empty-string token fields (confirmation_token, etc.); if
-- they are NULL, password login returns "Database error querying schema" — see
-- scripts/fix_auth_users_null_token_columns.sql for a repair UPDATE.
